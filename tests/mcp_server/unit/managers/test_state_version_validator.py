...
class TestStateVersionValidator:
    ...
    def test_state_version_validator_not_dict_raises_state_corrupted_error(
        ...
        """Verify that a state file containing a JSON list instead of a dict raises StateCorruptedError."""
    ...
    def test_state_version_validator_mismatch_raises_state_version_mismatch_error(
        ...
        """Verify that validating state.json with a mismatched version raises StateVersionMismatchError."""
    ...
    def test_state_version_validator_planning_mismatch_raises_planning_version_mismatch_error(
        ...
        """Verify that validating deliverables.json with a mismatched version raises PlanningVersionMismatchError."""
