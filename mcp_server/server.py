        ...
        if github_token:
            ...
            self.tools.extend(
                [
                    ...
                    AddLabelsTool(manager=self.github_manager, label_config=label_config, workphases_config=workphases_config),
                    ListLabelsTool(manager=self.github_manager, label_config=label_config),
                    CreateLabelTool(manager=self.github_manager, label_config=label_config, workphases_config=workphases_config),
