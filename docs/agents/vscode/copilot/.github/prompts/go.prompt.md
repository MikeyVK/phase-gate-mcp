...
agent: imp
argument-hint: Optional sub-role and mode. Examples: "documenter", "discuss", "adjust: use a light variant", "documenter, discuss", "documenter, adjust: use a light variant"
---
