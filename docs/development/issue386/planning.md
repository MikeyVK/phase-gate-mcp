...
<!-- template=planning version=130ac5ea created=2026-07-08T19:39Z updated=2026-07-08T21:40Z -->
...
*   Direct rename of environment variable setups in `tests/conftest.py` and mocks in `tests/mcp_server/unit/config/test_settings.py`.
...
*   User-facing and editor configuration templates (`mcp_config.json` and `mcp.json`).
...
*   `D1.4`: Update of pytest-monkeypatches in `test_settings.py` and `tests/conftest.py`.
...
*   `D2.2`: Updates in agent configurations (`mcp_config.json` and `mcp.json`).
